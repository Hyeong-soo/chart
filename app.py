...
cols[0].metric("GG CHEMICAL", format((int(pr.prices[pr.turn][0]/10000)*10000), ','), pr.gc)
cols[0].metric("MUSCAR", format((int(pr.prices[pr.turn][0]/10000)*10000), ','), pr.mc)
cols[1].metric("KOKOa", format((int(pr.prices[pr.turn][0]/10000)*10000), ','), pr.kk)
cols[1].metric("DTD", format((int(pr.prices[pr.turn][0]/10000)*10000), ','), pr.dt)
